...
/**
 * This is a PHAR __init file.
 * It will be automatically set as a stub when PHAR is created.
 * --
 * NOTE the SELF EXECUTION at the end.
 * --
 * @return void
 */
namespace dot\root\phar; function __init()
{
    /*
...
List of available commands:
    ...
    /*
    Get basepath of dot package. This path depends on package's format,
    which can be either source or .phar
     */
    $basepath = __FILE__;
    if (basename($basepath) !== '__init.php')
    {
    ...
    if (!file_exists($dotloc))
    {
        ...
        foreach (scandir($basepath.'/script') as $script)
        {
    ...
    if ($safe_mode)
    {
        ...
        // Include script
        include "{$basepath}/script/{$command}.php";
