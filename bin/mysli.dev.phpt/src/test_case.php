...
namespace mysli\dev\phpt; class test_case
{
    const __use = '
    ...
    function execute()
    {
        ...
        {
            $inputf = fs::ds("{$this->dir_temp}/{$this->filename_temp}.input");
        ...
        {
            $skipif = fs::ds("{$this->dir_temp}/{$this->filename_temp}.skipif.php");
        ...
        // test file
        $testf = fs::ds("{$this->dir_temp}/{$this->filename_temp}.php");
        file::write(
            $testf,
