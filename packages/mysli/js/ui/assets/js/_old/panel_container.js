mysli.js.ui.panel_container = (function () {
    ...
    panel_container.prototype = {
        ...
        update_view: function () {
            ...
            overflow_percent = 100 - common.get_percent(screen_left, this.sum_size - active_panel.size().width);
            offset_so_far = 0;
            panel_calculated = 0;
            ...
            this.panels.each(function (index, panel) {
                ...
                panel_calculated = common.set_percent(overflow_percent, panel.size().width);
         ...
         */
        insert: function (panel, after_id) {
            var index;

            if (!(panel instanceof mysli.js.ui.panel)) {
                throw new Error('An object must be instance of `mysli.js.ui.panel`');
            }
            ...
            panel.$element.css('z-index', 10000 - index);
            panel.event.connect('focus-change', this.switch_focus.bind(this));
         ...
         */
        push: function (panel) {
            return this.insert(panel, false);
        },
